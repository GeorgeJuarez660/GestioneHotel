...
@Repository
public interface AccedeRepository extends JpaRepository<Accede, Long> {

    public Optional<Accede> findByPrenotazioneCodice(String prenotazioneCodice);
    
    public Long countByPiscinaCodice(String codice);
